...
@MultipartConfig
@WebServlet(name = "CrudListaActividades", urlPatterns = {"/crudactividades/listaActividades"})
public class CrudListaActividades extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            actividades = consultas.listaCrudActividades();
