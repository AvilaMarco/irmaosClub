...
@MultipartConfig
@WebServlet(name = "CrudListaActividadesData", urlPatterns = {"/crudactividades/listaActividadesData"})
public class CrudListaActividadesData extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            actividades = consultas.listaCrudActividadesData();
